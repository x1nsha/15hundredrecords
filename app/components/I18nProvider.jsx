...
const dict = {
  en: {
    ...
    "showcase.title": "Artists",
    "playlists.title": "Playlists",
    "playlists.subtitle": "Curated selections from 15hundred — updated regularly.",
    ...
    "form.file.hint": "Attach .wav or .mp3 (max 25MB)",
    ...
    "error.file.type": "Only .wav or .mp3 files are allowed",
    "error.file.size": "File is too large (max 25MB)",
    "footer.rights": "All rights reserved.",
    "dashboard.title": "Dashboard",
    "dashboard.welcome": "In search of new hits!",
    "dashboard.refSaved": "Referral: {ref}",
    "dashboard.nowPlaying": "Now",
    "dashboard.timeNow": "Local time",
    "dashboard.quickLinks": "Quick links",
    "dashboard.gotoLanding": "Go to landing",
  ...
  ru: {
    ...
    "showcase.title": "Артисты",
    "playlists.title": "Плейлисты",
    "playlists.subtitle": "Кураторские подборки от 15hundred — регулярно обновляются.",
    ...
    "form.file": "Аудиофайл",
    "form.file.hint": "Приложите .wav или .mp3 (до 25 МБ)",
    ...
    "dashboard.welcome": "В поисках новых хитов!",
    "dashboard.refSaved": "Реферал: {ref}",
    "dashboard.nowPlaying": "Сейчас",
    "dashboard.timeNow": "Местное время",
    "dashboard.quickLinks": "Быстрые ссылки",
    "dashboard.gotoLanding": "К лендингу",
    "dashboard.contactUs": "Связаться",
  },
};
